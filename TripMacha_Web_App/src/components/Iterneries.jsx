...
const Iterneries = (props) => {
    ...
    return (
        <>
            <h6 className="bg-white text-center px-3 fs-3 mt-5" style={{ color: "#37249D" }}>Quick Itinerary Plan</h6>
            <h2 className="mb-5 text-center">Here is your Itinerary plans</h2>
