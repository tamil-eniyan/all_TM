        ...
        <>
            ...
            <nav style={{justifyContent:'center'}} className="navbar navbar-expand-lg navbar-light left-50 px-lg-5 py-3 py-lg-0 shadow-sm">
                <Link to="/" className="navbar-brand p-0"  >
                    <h1 className="text-primary m-0"><span style={{ color: '#37249D' , justifyContent: "center" }}><i className="fa fa-map-marked-alt me-3" ></i>Trip</span><span style={{ color: "red" }}>Macha</span></h1>
                </Link>
                <button className="navbar-toggler" hidden type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" >
