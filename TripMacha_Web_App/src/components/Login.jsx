...
const Login = () => {
    ...
    return (
        <>
            ...
            <div hidden style={{ background: "rgba(0,0,0,0.5)" }} className="modal fade element" id="SignupSigninModal" tabIndex="-1" role="dialog" aria-labelledby="SignupSigninModalLabel" aria-hidden="true">
